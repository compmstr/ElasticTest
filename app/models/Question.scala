...
case class Question(id: Long, user: Long, course: Long, lecture: Long, text: String, created: DateTime, tags: Array[String] = Array())
...
object Question{
  ...
  addQuestion(Question(-1, 2, 3, 1, "Example Question", DateTime.now(), Array("foo")))
  addQuestion(Question(-1, 3, 3, 1, "Example Question 2", DateTime.now(), Array("foo", "bar")))
  addQuestion(Question(-1, 4, 3, 2, "Example Question 3", DateTime.now(), Array("foo", "baz")))
  addQuestion(Question(-1, 2, 2, 1, "Another Question", DateTime.now()))
  addQuestion(Question(-1, 5, 2, 2, "How does this work?", DateTime.now(), Array("foo", "example")))
}